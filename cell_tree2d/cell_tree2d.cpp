...
static PyObject *__pyx_pf_11cell_tree2d_11cell_tree2d_8CellTree_6multi_locate(struct __pyx_obj_11cell_tree2d_11cell_tree2d_CellTree *__pyx_v_self, __Pyx_memviewslice __pyx_v_points, __Pyx_memviewslice __pyx_v_locations); /* proto */
...
/* Python wrapper */
static PyObject *__pyx_pw_11cell_tree2d_11cell_tree2d_8CellTree_7multi_locate(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_pw_11cell_tree2d_11cell_tree2d_8CellTree_7multi_locate(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_points,&__pyx_n_s_locations,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_locations)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("multi_locate", 1, 2, 2, 1); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 99; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "multi_locate") < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 99; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
      }
    ...
    __pyx_v_points = __Pyx_PyObject_to_MemoryviewSlice_dsds_double(values[0]); if (unlikely(!__pyx_v_points.memview)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 99; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_locations = __Pyx_PyObject_to_MemoryviewSlice_ds_int(values[1]); if (unlikely(!__pyx_v_locations.memview)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 99; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("multi_locate", 1, 2, 2, PyTuple_GET_SIZE(__pyx_args)); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 99; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  __pyx_L3_error:;
  __Pyx_AddTraceback("cell_tree2d.cell_tree2d.CellTree.multi_locate", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_11cell_tree2d_11cell_tree2d_8CellTree_6multi_locate(((struct __pyx_obj_11cell_tree2d_11cell_tree2d_CellTree *)__pyx_v_self), __pyx_v_points, __pyx_v_locations);
...
static PyObject *__pyx_pf_11cell_tree2d_11cell_tree2d_8CellTree_6multi_locate(struct __pyx_obj_11cell_tree2d_11cell_tree2d_CellTree *__pyx_v_self, __Pyx_memviewslice __pyx_v_points, __Pyx_memviewslice __pyx_v_locations) {
  int __pyx_v_i;
  int __pyx_v_size;
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  ...
  /* "cell_tree2d\cell_tree2d.pyx":102
 *         cdef int i
 *         cdef int size
 *         i = 0             # <<<<<<<<<<<<<<
 *         size = points.shape[0]
 ...
 * 
 */
    __pyx_t_2.data = __pyx_v_points.data;
    __pyx_t_2.memview = __pyx_v_points.memview;
...
__pyx_t_2.shape[0] = __pyx_v_points.shape[1];
__pyx_t_2.strides[0] = __pyx_v_points.strides[1];
    __pyx_t_2.suboffsets[0] = -1;

__pyx_t_3 = 0;
    if (__pyx_t_3 < 0) __pyx_t_3 += __pyx_t_2.shape[0];
    __pyx_t_4 = __pyx_v_i;
    if (__pyx_t_4 < 0) __pyx_t_4 += __pyx_v_locations.shape[0];
    __pyx_t_5 = ((struct __pyx_vtabstruct_11cell_tree2d_11cell_tree2d_CellTree *)__pyx_v_self->__pyx_vtab)->c_find_poly(__pyx_v_self, (&(*((double *) ( /* dim=0 */ (__pyx_t_2.data + __pyx_t_3 * __pyx_t_2.strides[0]) )))), (&(*((int *) ( /* dim=0 */ (__pyx_v_locations.data + __pyx_t_4 * __pyx_v_locations.strides[0]) ))))); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 105; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_5);
...
static PyMethodDef __pyx_methods_11cell_tree2d_11cell_tree2d_CellTree[] = {
  ...
  {"multi_locate", (PyCFunction)__pyx_pw_11cell_tree2d_11cell_tree2d_8CellTree_7multi_locate, METH_VARARGS|METH_KEYWORDS, 0},
  {0, 0, 0, 0}
};
