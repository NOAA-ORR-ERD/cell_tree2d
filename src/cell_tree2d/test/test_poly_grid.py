...
"""
tests for using celltree with a polygon grid

e.g. voronoi polygons

This is a pathological example provided in:

https://github.com/NOAA-ORR-ERD/cell_tree2d/issues/13
